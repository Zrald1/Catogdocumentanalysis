...
type PromptMetadata struct {
	...
	ContainsHallucination     bool     `json:"contains_hallucination"`
...
func (ins *Inspector) Inspect(text string) *PromptMetadata {
	...
	meta.ContainsHallucination = HallucinationPatterns.MatchAny(text)
	...
	meta.RiskScore = ComputeRisk(RiskSignals{
		...
		ContainsHallucination:     meta.ContainsHallucination,
